					...
					<div class="form-input-content">
						<div class="card login-form mb-0">
							<div class="card-body pt-5">
								...
								<form:form commandName="searchVO" id="login_form" method="POST"
									class="mt-5 mb-5 login-input" name="login_form">
									...
									<div class="form-group">
										<input type="password" name="passwd" id="passwd"
											class="form-control" placeholder="패스워드" maxlength="50">
									</div>
									</form>
									...
									<p class="mt-5 login-form__footer" style="text-align: center">
										<a href="#" class="text-primary" onclick="idpassLookup();">아이디
											찾기 ㅣ 비밀번호 찾기</a>
									</p>
								</form:form>
							</div>
